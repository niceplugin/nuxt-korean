...
이 예시에서는 [Pinia 모듈](/modules/pinia)을 활용하여 전역 스토어를 만들고 앱 전체에서 사용합니다.
...
- [Pinia](/modules/pinia) - 공식 Vue 권장 솔루션
- [Harlem](/modules/harlem) - 불변 전역 상태 관리
- [XState](/modules/xstate) - 상태 머신 방식, 상태 로직 시각화 및 테스트 도구 제공
